...
from scripts.log_matchbook_paper_trades import main as log_matchbook_main
...
def test_cli_writes_inserted_count(tmp_path, monkeypatch) -> None:
    paper_db = tmp_path / "paper.sqlite3"
    opportunities_csv = tmp_path / "opportunities.csv"

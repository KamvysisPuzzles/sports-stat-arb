...
def test_recompute_sharpness_weights_scores_books_against_closing_benchmark(tmp_path) -> None:
    ...
    early_prices = [
        price(bookmaker_key="pinnacle", bookmaker_title="Pinnacle", outcome_name="Arsenal", odds=2),
        price(bookmaker_key="pinnacle", bookmaker_title="Pinnacle", outcome_name="Chelsea", odds=2),
        price(bookmaker_key="soft", bookmaker_title="Soft Book", outcome_name="Arsenal", odds=1.5),
        price(bookmaker_key="soft", bookmaker_title="Soft Book", outcome_name="Chelsea", odds=3),
    ]
    closing_prices = [
        price(bookmaker_key="pinnacle", bookmaker_title="Pinnacle", outcome_name="Arsenal", odds=2),
        price(bookmaker_key="pinnacle", bookmaker_title="Pinnacle", outcome_name="Chelsea", odds=2),
        price(bookmaker_key="soft", bookmaker_title="Soft Book", outcome_name="Arsenal", odds=1.8),
        price(bookmaker_key="soft", bookmaker_title="Soft Book", outcome_name="Chelsea", odds=2.2),
    ]
    ...
    assert by_book["soft book"].weight < by_book["pinnacle"].weight
